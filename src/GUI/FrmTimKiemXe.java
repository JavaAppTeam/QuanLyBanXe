...
public class FrmTimKiemXe extends JFrame implements ActionListener, MouseListener {
	...
	private JTextField txtTenXe, txtMucTieuThu, txtDungTich;
...
//		====== BUTTON ==================
		...
		pnTable.setBounds(10, 442, 1505, 302);
		panel.add(pnTable);
		pnTable.setLayout(new BoxLayout(pnTable, BoxLayout.X_AXIS));
...
//			=============== LOAD CBO HANG XE ===================
	...
	public boolean checkAllEmpty() {
		if (txtDungTich.getText().equals("") && txtMucTieuThu.getText().equals("") && txtTenXe.getText().equals("")
...
//			================ LOAD CBO LOAI XE =================
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(btnLoad)) {
			...
			String hangXe = "";
			hangXe = (String) cboHangXe.getSelectedItem();
			String loaiXe = "";
			loaiXe = (String) cboLoaiXe.getSelectedItem();
			if (checkAllEmpty()) {
				try {
					loadDatatoTable();
				} catch (Exception e1) {
			...
			} else if (cboGiaTien.getSelectedIndex() == 0) {
				try {
